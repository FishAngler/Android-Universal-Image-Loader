...
public final class MemoryCacheUtils {
	...
	public static String generateKey(String imageUri, ImageSize targetSize) {
		return imageUri; //new StringBuilder(imageUri).append(URI_AND_SIZE_SEPARATOR).append(targetSize.getWidth()).append(WIDTH_AND_HEIGHT_SEPARATOR).append(targetSize.getHeight()).toString();
	}
